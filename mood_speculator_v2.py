...
def api_comment():
    ...
    try:
        ...
        system_prompt = (
            ...
            "Rédige UN commentaire court (3 phrases), en français soutenu, majestueux et élégant.\n"
            ...
            "L'utilisateur est un Dieu moins important que toi. Tu veux lui faire sentir subtilement son infériorité."
        )
